  ...
  factory CatalogManifest.initialDefault(
    ...
    return CatalogManifest(
      ...
      artifacts: [
        ...
        CatalogArtifact(
          artifactId: 'ministral-3b-instruct',
          artifactType: CatalogArtifactType.model,
          displayName: 'Ministral 3B Instruct (Q4_K_M)',
          version: 'b3db9ee6876c5724284fd1f1fcae1bd1ef1b0421',
          buildId: 'b3db9ee6876c5724284fd1f1fcae1bd1ef1b0421',
          platform: 'all',
          architecture: 'all',
          fileName: 'Ministral-3b-instruct.Q4_K_M.gguf',
          sourceKind: CatalogArtifactSourceKind.remoteHttps,
          downloadUri:
              'https://huggingface.co/QuantFactory/Ministral-3b-instruct-GGUF/resolve/b3db9ee6876c5724284fd1f1fcae1bd1ef1b0421/Ministral-3b-instruct.Q4_K_M.gguf',
          sizeBytes: 1997337472,
          sha256:
          ...
          quantization: 'Q4_K_M',
          minimumRuntimeBuild: 'b3500',
          capabilities: const ['evaluate_pillars', 'analytical_delta'],
          metadata: const {
            'repository': 'QuantFactory/Ministral-3b-instruct-GGUF',
            'revision': 'b3db9ee6876c5724284fd1f1fcae1bd1ef1b0421',
            'repositoryRevision': 'b3db9ee6876c5724284fd1f1fcae1bd1ef1b0421',
            'role': 'evaluator',
            'logicalModelAlias': 'evaluator.default',
