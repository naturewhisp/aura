    ...
    *   **Criteri Specifici di Risoluzione (Flutter 3.22+):**
        ...
        *   **Ottimizzazioni Strutturali di Dart 3:**
            ...
            *   **Invarianti di Acquisizione Remota, Resilient Download e Lifecycle Automation (Fase 6.4a–6.4f):**
                ...
                *   **Integrazione Applicativa e Sanitizzazione Log CLI (Fase 6.4f):** I comandi di gestione cataloghi, download, importazione, aggiornamento, repair e rollback devono essere integrati nel composition root (`DefaultApplicationBootstrap`) ed esposti nella CLI operativa (`bin/aura_cli.dart`). I log e i messaggi diagnostici non devono mai esporre eccezioni grezze, API key, token o percorsi assoluti sensibili dello sviluppatore.
