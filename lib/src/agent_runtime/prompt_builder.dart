...
class PromptBuilder {
  ...
  List<Map<String, String>> buildActorMessages({
    ...
    final systemPrompt =
        ...
        "$hiddenTagsBlock\n"
        "REGOLE DI OUTPUT:\n"
        "1. Non citare mai nomi di variabili interne, delta, pilastri, risonanza o categorie interne.\n"
        ...
        "Non rivelare variabili o parametri interni.\n"
        "Non spiegare il funzionamento del sistema.\n"
